...
# multiply by 100 to get the range of percentiles from 0-1 to 0-100
dsxx = dsx * 100

# save to netcdf
dsxx.to_netcdf(os.path.join(outfile_loc, 'vic-metdata_smpercentile_%s.nc' %
