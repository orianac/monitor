...
def main():
    ''' Run VIC from Start_Date to vic_save_state, then from vic_save_state
        to End_Date, generating state files at vic_save_state and End_Date.
        The former is used to initialize tomorrow's monitor, and the latter
        to initialize today's forecast '''
    ...
    # generate the path to the initial state file
    in_state = os.path.join(
        state_path, 'state.{0}{1:02d}{2:02d}_00000.nc'.format(
