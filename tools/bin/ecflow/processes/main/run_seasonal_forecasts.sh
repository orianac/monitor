...
python ${scriptdir}/meteorological/get_seasonal_metfcst.py ${configdir}/working_python_US.cfg

python ${scriptdir}/meteorological/run_metsim_metgrid.py ${configdir}/working_python_US.cfg SEAS_FCST
python ${scriptdir}/models/prep_and_run_vic.py ${configdir}/working_python_US.cfg SEAS_FCST

python ${scriptdir}/post_processing/merge_forecasts.py ${configdir}/working_python_US.cfg SEAS_FCST
python ${scriptdir}/post_processing/analysis_forecasts.py ${configdir}/working_python_US.cfg SEAS_FCST
python ${scriptdir}/post_processing/file_transfer.py ${configdir}/working_python_US.cfg SEAS_FCST
